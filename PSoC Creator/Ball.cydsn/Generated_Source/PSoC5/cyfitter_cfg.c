...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x480009C8u)
...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x480009D8u)

/* IOPINS0_8 Address: CYREG_PRT15_DR Size (bytes): 10 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x480009E4u)

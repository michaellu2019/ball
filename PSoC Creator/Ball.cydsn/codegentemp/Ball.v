...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=true, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=109, CompareValue2=0, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=219, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=RC_PWM, CY_INSTANCE_SHORT_NAME=RC_PWM, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=RC_PWM, )
module PWM_v3_30_1 (
    pwm2,
    tc,
    clock,
...
// Counter_v3_0(CaptureMode=1, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=0, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=65535, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=true, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Counter_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=RC_Counter, CY_INSTANCE_SHORT_NAME=RC_Counter, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=RC_Counter, )
...
module top ;
    ...
    PWM_v3_30_0 Motor_A_PWM (
        ...
        .ph1(Net_164),
        .ph2(Net_165));
    defparam Motor_A_PWM.Resolution = 8;
	...
	wire [0:0] tmpOE__Motor_A_Output_In1_net;
	wire [0:0] tmpFB_0__Motor_A_Output_In1_net;
	wire [0:0] tmpIO_0__Motor_A_Output_In1_net;
	wire [0:0] tmpINTERRUPT_0__Motor_A_Output_In1_net;
	electrical [0:0] tmpSIOVREF__Motor_A_Output_In1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_A_Output_In1
		 (.oe(tmpOE__Motor_A_Output_In1_net),
		  .y({Net_140}),
		  .fb({tmpFB_0__Motor_A_Output_In1_net[0:0]}),
		  .io({tmpIO_0__Motor_A_Output_In1_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_A_Output_In1_net),
		  .interrupt({tmpINTERRUPT_0__Motor_A_Output_In1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_A_Output_In1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor_A_Output_In2_net;
	wire [0:0] tmpFB_0__Motor_A_Output_In2_net;
	wire [0:0] tmpIO_0__Motor_A_Output_In2_net;
	wire [0:0] tmpINTERRUPT_0__Motor_A_Output_In2_net;
	electrical [0:0] tmpSIOVREF__Motor_A_Output_In2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ddaa27cd-195f-4177-9b15-4ebcfc487cd1"),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_A_Output_In2
		 (.oe(tmpOE__Motor_A_Output_In2_net),
		  .y({Net_156}),
		  .fb({tmpFB_0__Motor_A_Output_In2_net[0:0]}),
		  .io({tmpIO_0__Motor_A_Output_In2_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_A_Output_In2_net),
		  .interrupt({tmpINTERRUPT_0__Motor_A_Output_In2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_A_Output_In2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_1 RC_PWM (
        ...
        .ph1(Net_887),
        .ph2(Net_888));
    defparam RC_PWM.Resolution = 8;

    assign Net_377 = 1'h0;

	wire [0:0] tmpOE__RC_Count_1_net;
	wire [0:0] tmpIO_0__RC_Count_1_net;
	wire [0:0] tmpINTERRUPT_0__RC_Count_1_net;
	electrical [0:0] tmpSIOVREF__RC_Count_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		RC_Count_1
		 (.oe(tmpOE__RC_Count_1_net),
		  .y({1'b0}),
		  .fb({Net_366}),
		  .io({tmpIO_0__RC_Count_1_net[0:0]}),
		  .siovref(tmpSIOVREF__RC_Count_1_net),
		  .interrupt({tmpINTERRUPT_0__RC_Count_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RC_Count_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Counter_v3_0_2 RC_Counter (
        .reset(Net_377),
        .tc(Net_378),
        .comp(Net_379),
        .clock(Net_48),
        ...
        .up_ndown(1'b1),
        .count(Net_366));
    defparam RC_Counter.CaptureMode = 1;
    defparam RC_Counter.ClockMode = 0;
    defparam RC_Counter.CompareMode = 1;
    defparam RC_Counter.CompareStatusEdgeSense = 1;
    defparam RC_Counter.EnableMode = 0;
    defparam RC_Counter.ReloadOnCapture = 1;
    defparam RC_Counter.ReloadOnCompare = 0;
    defparam RC_Counter.ReloadOnOverUnder = 1;
    defparam RC_Counter.ReloadOnReset = 1;
    defparam RC_Counter.Resolution = 16;
    defparam RC_Counter.RunMode = 0;
    defparam RC_Counter.UseInterrupt = 1;
	...
	wire [0:0] tmpOE__RC_Count_2_net;
	wire [0:0] tmpIO_0__RC_Count_2_net;
	wire [0:0] tmpINTERRUPT_0__RC_Count_2_net;
	electrical [0:0] tmpSIOVREF__RC_Count_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("65c37a14-b020-409d-8793-bccaa6a550ab"),
		  ...
		  .input_buffer_sel(2'b00))
		RC_Count_2
		 (.oe(tmpOE__RC_Count_2_net),
		  .y({1'b0}),
		  .fb({Net_1049}),
		  .io({tmpIO_0__RC_Count_2_net[0:0]}),
		  .siovref(tmpSIOVREF__RC_Count_2_net),
		  .interrupt({tmpINTERRUPT_0__RC_Count_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RC_Count_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_70_4 RC_Timer (
        .reset(Net_12),
        .interrupt(Net_919),
        .enable(1'b1),
        .trigger(Net_1049),
        .capture(Net_1049),
        .capture_out(Net_1059),
        .tc(Net_1060),
        .clock(Net_10));
    defparam RC_Timer.CaptureCount = 2;
    defparam RC_Timer.CaptureCounterEnabled = 0;
    defparam RC_Timer.DeviceFamily = "PSoC5";
    defparam RC_Timer.InterruptOnCapture = 1;
    defparam RC_Timer.InterruptOnTC = 0;
    defparam RC_Timer.Resolution = 32;
    defparam RC_Timer.SiliconRevision = "0";

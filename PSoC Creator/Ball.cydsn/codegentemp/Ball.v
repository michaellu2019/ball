...
// Timer_v2_70(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=4, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG24, CySetRegReplacementString=CY_SET_REG24, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=true, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=1, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=499999, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, Resolution=24, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=true, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=true, TriggerMode=2, UDB16=false, UDB24=true, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT24, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Timer_v2_70, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=RC_Connection_Timer, CY_INSTANCE_SHORT_NAME=RC_Connection_Timer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=RC_Connection_Timer, )
...
module top ;
    ...
    Timer_v2_70_1 RC_Connection_Timer (
        .reset(Net_1138),
        .interrupt(Net_1117),
        .enable(1'b1),
        .trigger(Net_1049),
        .capture(Net_1049),
        .capture_out(Net_1140),
        .tc(Net_1141),
        .clock(Net_10));
    defparam RC_Connection_Timer.CaptureCount = 2;
    defparam RC_Connection_Timer.CaptureCounterEnabled = 0;
    defparam RC_Connection_Timer.DeviceFamily = "PSoC5";
    defparam RC_Connection_Timer.InterruptOnCapture = 0;
    defparam RC_Connection_Timer.InterruptOnTC = 1;
    defparam RC_Connection_Timer.Resolution = 24;
    defparam RC_Connection_Timer.SiliconRevision = "0";


	cy_isr_v1_0
		#(.int_type(2'b10))
		RC_Connection_Timer_Interrupt
		 (.int_signal(Net_1117));
	...
	wire [0:0] tmpOE__RC_Ch_2_net;
	wire [0:0] tmpIO_0__RC_Ch_2_net;
	wire [0:0] tmpINTERRUPT_0__RC_Ch_2_net;
	electrical [0:0] tmpSIOVREF__RC_Ch_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("65c37a14-b020-409d-8793-bccaa6a550ab"),
		  ...
		  .input_buffer_sel(2'b00))
		RC_Ch_2
		 (.oe(tmpOE__RC_Ch_2_net),
		  .y({1'b0}),
		  .fb({Net_1049}),
		  .io({tmpIO_0__RC_Ch_2_net[0:0]}),
		  .siovref(tmpSIOVREF__RC_Ch_2_net),
		  .interrupt({tmpINTERRUPT_0__RC_Ch_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RC_Ch_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
